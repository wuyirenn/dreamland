            ...
            <div className="text-white font-avantgarde drop-shadow-md">
                ...
                <div className="grid md:grid-cols-5 xl:grid-cols-9 gap-4 text-xs lg:text-sm text-left font-medium">
                    <div className="col-span-full font-semibold text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-left">
                        Forever enamored with people, community, and technology.
                    </div>
                    <div className="md:col-span-3 xl:col-span-4">
                        {`I fell in love with the world in the era of digital point-and-shoots. Through the tiny, electric viewfinder of my mom's silver Canon, 
                        I'd capture incredible wonders -- serene seaside views and towering monuments, but also garden roses and subway passerby. I've learned that there is always magic to be found, if only I look. 
                ...
                <div className="relative border-l-2 border-white text-xs lg:text-sm">
                    ...
                    <ul className="list-none pl-4 max-h-[240px] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                        <TimelineEvent role="artist" org="ink on paper" year="2022 - current" />
                        <TimelineEvent role="chief of staff" org="halo" year="2025" />
                        ...
                        <TimelineEvent role="freelance" org="film, photography, graphic design" year="2018 - 2022" />
                    </ul>
                </div>
            </div>
        </main>
