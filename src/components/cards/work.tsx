        ...
        <main className="relative">
            <div className="text-white font-avantgarde drop-shadow-md">
                ...
                <div className="grid gap-4 text-xs text-left font-medium">
                    ...
                    <div className="col-span-full">
                        {`I am quite proud of the progress so far though. This site takes inspiration from Minh Pham and Fernando Pinto, designed loosely with pen and paper, 
                        coded in VS Code, prototyped in Figma, and built with Next.js and Tailwind CSS.`}
                    </div>
                    <div className="col-span-full">   
                        ...
                        Inspired by the old Alto's Odyssey iPhone game, it embodies freedom and contains my love for desert scenery. Lastly, the music was 
                        composed by Tim @ Tabletop Audio. His music speaks for itself -- it's beautiful.`}
                    </div>
                </div>
            </div>
        </main>
